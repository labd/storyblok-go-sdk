...
type FieldInput struct {
	// AddHttps Prepends 'https:' to avoid relative protocol issues (image/file fields).
	AddHttps *bool `json:"add_https,omitempty"`

	// AllowAdvancedSearch Allows advanced search in option fields.
	AllowAdvancedSearch *bool `json:"allow_advanced_search,omitempty"`

	// AllowCustomAttributes Enables custom attributes in links for richtext or multilink fields.
	AllowCustomAttributes *bool `json:"allow_custom_attributes,omitempty"`

	// AllowExternalUrl Allows external URLs in asset or multiasset fields.
	AllowExternalUrl *bool `json:"allow_external_url,omitempty"`

	// AllowMultiline Enables empty paragraphs in markdown fields.
	AllowMultiline *bool `json:"allow_multiline,omitempty"`

	// AllowTargetBlank Allows links in richtext to open in a new tab.
	AllowTargetBlank *bool `json:"allow_target_blank,omitempty"`

	// AssetFolderId Defines the asset folder for uploaded images (asset fields).
	AssetFolderId *int64 `json:"asset_folder_id,omitempty"`

	// AssetLinkType Allows assets in multilink fields.
	AssetLinkType *bool `json:"asset_link_type,omitempty"`

	// CanSync Allows syncing with the field in preview (advanced usage).
	CanSync *bool `json:"can_sync,omitempty"`

	// ComponentGroupWhitelist Array of group UUIDs for restricting components in bloks fields.
	ComponentGroupWhitelist *[]string `json:"component_group_whitelist,omitempty"`

	// ComponentTagWhitelist Array of tag IDs for restricting components in bloks fields.
	ComponentTagWhitelist *[]int `json:"component_tag_whitelist,omitempty"`

	// ComponentWhitelist Array of component names that can be used in bloks, multilink, or richtext.
	ComponentWhitelist *[]string `json:"component_whitelist,omitempty"`

	// ConditionalSettings Array containing conditional settings for the field.
	ConditionalSettings *[]ConditionalSettings `json:"conditional_settings,omitempty"`

	// CustomizeToolbar True if richtext or markdown toolbar can be customized.
	CustomizeToolbar *bool `json:"customize_toolbar,omitempty"`

	// DatasourceSlug Defines the selectable datasource for options (internal sources).
	...
	// DisableTime Disables time selection for datetime fields.
	DisableTime *bool `json:"disable_time,omitempty"`

	// DisplayName Name used in the editor interface.
	DisplayName *string `json:"display_name,omitempty"`

	// EmailLinkType Allows emails in multilink fields.
	EmailLinkType *bool `json:"email_link_type,omitempty"`

	// EntryAppearance Appearance of an option (link or card) in an option field.
	EntryAppearance *string `json:"entry_appearance,omitempty"`

	// ExcludeEmptyOption Hides empty options in option fields.
	ExcludeEmptyOption *bool `json:"exclude_empty_option,omitempty"`

	// ExcludeFromMerge Excludes a blok from merge actions (Dimensions App).
	ExcludeFromMerge *bool `json:"exclude_from_merge,omitempty"`

	// ExcludeFromOverwrite Excludes a blok from overwrite actions (Dimensions App).
	ExcludeFromOverwrite *bool `json:"exclude_from_overwrite,omitempty"`

	// ExternalDatasource Defines external datasource URL for options.
	ExternalDatasource *string `json:"external_datasource,omitempty"`

	// FieldType Name of the custom field type plugin (custom fields).
	FieldType *string `json:"field_type,omitempty"`

	// Filetypes Array of file types for multiasset fields (e.g., images, videos).
	Filetypes *[]string `json:"filetypes,omitempty"`

	// FilterContentType Array of content types that can be selected in an option field.
	FilterContentType *[]string `json:"filter_content_type,omitempty"`

	// FolderSlug Defines a folder filter for internal stories in options.
	FolderSlug *string `json:"folder_slug,omitempty"`

	// ForceLinkScope Forces folder restrictions in multilink fields.
	ForceLinkScope *bool `json:"force_link_scope,omitempty"`

	// ForceMerge Forces overwriting a blok during a merge action (Dimensions App).
	ForceMerge *bool `json:"force_merge,omitempty"`

	// ImageCrop Activates forced image cropping (image fields).
	ImageCrop *bool `json:"image_crop,omitempty"`

	// ImageHeight Defines image height in pixels or ratio (image fields).
	ImageHeight *string `json:"image_height,omitempty"`

	// ImageWidth Defines image width in pixels or ratio (image fields).
	ImageWidth *string `json:"image_width,omitempty"`

	// InlineLabel Makes the label of a boolean field inline.
	InlineLabel *bool `json:"inline_label,omitempty"`

	// IsReferenceType True if the options field is of type reference.
	IsReferenceType *bool `json:"is_reference_type,omitempty"`

	// KeepImageSize Keeps the original image size (image fields).
	KeepImageSize *bool `json:"keep_image_size,omitempty"`

	// Keys Array of field keys for group field types.
	Keys *[]string `json:"keys,omitempty"`

	// LinkScope Defines folder filtering for multilink fields.
	LinkScope *string `json:"link_scope,omitempty"`

	// MaxLength Maximum length for text, textarea, or markdown fields.
	...
	// NoTranslate Excludes the field from translation export (for text and number types).
	NoTranslate *bool `json:"no_translate,omitempty"`

	// Options Array of data source entries for option fields.
	Options *[]FieldOption `json:"options,omitempty"`

	// Pos Position of the field in the component.
	Pos int64 `json:"pos"`

	// Regex Regex validation for text fields.
	Regex *string `json:"regex,omitempty"`

	// Required Is this field required?
	Required *bool `json:"required,omitempty"`

	// RequiredFields Comma-separated list of required fields for custom fields.
	RequiredFields *string `json:"required_fields,omitempty"`

	// RestrictComponents Enables restriction for nestable components in bloks (for bloks and richtext).
	RestrictComponents *bool `json:"restrict_components,omitempty"`

	// RestrictContentTypes Activates restriction for content types in multilink fields.
	RestrictContentTypes *bool `json:"restrict_content_types,omitempty"`

	// RestrictType Restricts the type of components used in bloks fields (e.g., tags, groups).
	RestrictType *string `json:"restrict_type,omitempty"`

	// RichMarkdown Enables rich markdown view for markdown fields.
	RichMarkdown *bool `json:"rich_markdown,omitempty"`

	// Rtl Enables RTL for markdown, text, or textarea fields.
	Rtl *bool `json:"rtl,omitempty"`

	// ShowAnchor Enables anchor field for internal links in multilink fields.
	ShowAnchor *bool `json:"show_anchor,omitempty"`

	// Source Defines where options are sourced from (e.g., internal stories, external APIs).
	...
	// Toolbar Array of enabled items when customizing the toolbar for richtext/markdown.
	Toolbar *[]string `json:"toolbar,omitempty"`

	// Tooltip True if description is shown as a tooltip.
	Tooltip *bool `json:"tooltip,omitempty"`

	// Translatable True if translation is enabled over the field.
	Translatable *bool `json:"translatable,omitempty"`

	// Type The type of your field.
	Type string `json:"type"`

	// UseUuid Specifies if UUID should be used in options.
